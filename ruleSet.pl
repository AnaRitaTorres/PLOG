...
getBest_IterateY(ThisY, ivory, BoardIn, IvoryStackIn, CigarStackIn, (_,_,_,_,Score)) :- ThisY == 12, Score = -1.
...
getBest_IterateX(ThisX, ThisY, ivory, BoardIn, IvoryStackIn, CigarStackIn, (_,_,_,_,Score)) :- ThisX == 12, Score = -1.
...
getBest_IterateY(ThisY, cigar, BoardIn, IvoryStackIn, CigarStackIn, (_,_,_,_,Score)) :- ThisY == 12, Score = -1.
...
getBest_IterateX(ThisX, ThisY, cigar, BoardIn, IvoryStackIn, CigarStackIn, (_,_,_,_,Score)) :- ThisX == 12, Score = -1.
...
getBestTarget_IterateY(IterY, Player, ThisX, ThisY, BoardIn, IvoryStackIn, CigarStackIn, (_,_,_,_, Score)) :- IterY == 12, Score = -1.
...
getBestTarget_IterateX(IterX, IterY, Player, ThisX, ThisY, BoardIn, IvoryStackIn, CigarStackIn, (_,_,_,_, Score)) :- IterX == 12, Score = -1.
getBestTarget_IterateX(IterX, IterY, Player, ThisX, ThisY, BoardIn, IvoryStackIn, CigarStackIn, (X, Y, TargetX, TargetY, Score)) :-
						IterX \= 12,
						((makePlay((Player,ThisX,ThisY,IterX,IterY),(IvoryStackIn,CigarStackIn,BoardIn),(IvoryStackOut, CigarStackOut, BoardOut), GameOver) ->
...
judgeScores((ResultingX, ResultingY, ResultingTargetX, ResultingTargetY,ResultingScore),(X1, Y1, TargetX1, TargetY1,Score1),(X2, Y2, TargetX2, TargetY2, Score2)) :-
			Score1 >= Score2,
...
playBestBot(Player, Play, (IvoryStackIn, CigarStackIn, BoardIn),(IvoryStackOut, CigarStackOut, BoardOut), GameOver) :-
				getBestPlay(Player, BoardIn, IvoryStackIn, CigarStackIn, (X,Y,TargetX,TargetY,Score)),
				Play = (Player, X, Y, TargetX, TargetY),
